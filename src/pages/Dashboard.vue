<template>
  <section id="dashboard">
    <div>
      <b-navbar toggleable="lg" variant="light" text="dark">
        <b-navbar-brand href="#"
          ><img
          ...
          <b-navbar-nav class="ml-auto">
            ...
            <b-nav-form>
              <mdb-btn color="secondary" rounded>
                <router-link to="/home" class="sala"
                  >Crear sala</router-link
                ></mdb-btn
              >
            </b-nav-form>
          ...
          <mdb-card class="mb-4">
            <mdb-card-body>
              <mdb-list-group class="list-group-flush">
                ...
                <mdb-list-group-item action waves
                  >Orders
                  <mdb-badge color="primary-color" pill class="pull-right"
                    >14</mdb-badge
                  >
                </mdb-list-group-item>
                <mdb-list-group-item action waves
                      ...
                      >
                        <mdb-modal-body class="text-center">
                          <span
                            ...
                            elit. Impedit nisi quo provident fugiat
                            reprehenderit nostrum quos...</span
                          >
                          <mdb-btn
                            color="secondary"
                            @click.native="showFrameModalTop = false"
                            >Close</mdb-btn
                          >
                    ...
                    <div class="text-center">
                      ...
                      >
                        ...
                        <mdb-modal-footer>
                          <mdb-btn
                            color="secondary"
                            @click.native="showFluidModalTop = false"
                            >Close</mdb-btn
                          >
                          <mdb-btn color="primary">Save changes</mdb-btn>
                        </mdb-modal-footer>
