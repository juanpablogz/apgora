...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form>
      ...
      <input v-model="passwordConfirmation" type="text" id="password" class="fadeIn third" name="login" placeholder="password">
    ...
    <div id="formFooter">
      ...
      <a class="underlineHover" href="/#/sign-in">Iniciar sesión</a>
    </div>
